  ...
  Protection: {
    ...
    talents: {
      ...
      "Shield Slam": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Slam the target with your shield, causing 225 to 236 damage, modified by your shield block value, and has a 50% chance of dispelling 1 magic effect on the target. Also causes a high amount of threat. (6 sec. cooldown)`,
      },
    },
  },
};
