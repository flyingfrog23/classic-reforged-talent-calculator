  ...
  Balance: {
    ...
    talents: {
      ...
      "Subtlety": {
        ...
        maxRank: 5,
        reqPoints: 5,
        description: talentText`Reduces the threat generated by your Balance and Restoration spells by ${[
          5,
          10,
          15,
          20,
  ...
  "Feral Combat": {
    ...
    talents: {
      ...
      "Leader of the Pack": {
        ...
        maxRank: 1,
        reqPoints: 30,
        description: talentText`While in Cat, Bear or Dire Bear Form, the Leader of the Pack increases the chance to dodge, the chance to hit and the critical chance of all party members within 45 yards by 3%`,
      },
    },
  },
  Restoration: {
