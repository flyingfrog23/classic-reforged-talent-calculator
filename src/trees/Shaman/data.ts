  ...
  Elemental: {
    ...
    talents: {
      ...
      "Elemental Mastery": {
        ...
        description: talentText`When activated, this spell gives your next Fire, Frost, or Nature damage spell a 100% critical strike chance and reduces the mana cost by 100%. (120 sec. cooldown)`,
      },
    },
  },
  Enhancement: {
    ...
    talents: {
      ...
      "Stormstrike": {
        ...
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Gives you an extra attack. In addition, the next 2 sources of Nature damage dealt to the target are increased by 20%. Lasts 12 sec. (15 sec. cooldown)`,
      },
    },
  },
  Restoration: {
    ...
    talents: {
      ...
      "Grace": {
        ...
        maxRank: 3,
        reqPoints: 10,
        description: talentText`Reduces the threat generated by your elemental and restoration spells by ${[
          5,
          10,
          15,
        ]}%.`,
      ...
      "Nature's Swiftness": {
        ...
        maxRank: 1,
        reqPoints: 20,
        description: talentText`When activated, your next Nature spell with a casting time less than 10 sec. becomes an instant cast spell. (180 sec. cooldown)`,
      },
      "Purification": {
        name: "Purification",
        pos: "f3",
      ...
      "Mana Tide Totem": {
        ...
        description: talentText`Summons a Mana Tide Totem with 5 health at the feet of the caster for 12 sec that restores 170 mana every 3 seconds to group members within 20 yards. (5 min cooldown)`,
      },
    },
  },
};
